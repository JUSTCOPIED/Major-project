...
export function CTA(){
  return (
    <section id="cta" className="scroll-mt-24 py-32 text-center px-6 md:px-12 lg:px-20 max-w-5xl mx-auto">
      <motion.div initial={{opacity:0,scale:0.95}} whileInView={{opacity:1,scale:1}} transition={{duration:0.6}} className="p-10 rounded-sm border border-border bg-card text-card-foreground space-y-6">
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight">Make Hiring Your Competitive Edge</h2>
